...
describe('Punch a single TLP STATE order for class 8 with Byjus Assure as Loan payment and Gpay as Down payment',()=>{

    it('Punch a single TLP STATE order for class 8 with Byjus Assure as Loan payment and Gpay as Down payment',()=>{
