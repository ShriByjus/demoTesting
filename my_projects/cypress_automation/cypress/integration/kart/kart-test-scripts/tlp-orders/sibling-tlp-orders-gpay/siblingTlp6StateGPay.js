...
describe('Punch a TLP sibling order with state board class 6 and class 8 for second sibling using GPay payment',()=>{
   
    it('Punch a TLP sibling order with state board class 6 and class 8 for second sibling using GPay payment',()=>{
        const board = customerinfo.board[2]
        const initialGrade = customerinfo.initialGrade[7]
        const finalGrade = customerinfo.finalGrade[7]
        const secondSiblingInitialGrade = customerinfo.initialGrade[9]
        const secondSiblingFinalGrade = customerinfo.finalGrade[9]
