...
describe('Punch a single Byjus classes Cbse order for class 6 with Pinelbs payment',()=>{
   
    it('Punch a single byjus trialpack  Cbse order for class 6 with Pinelabs payment',()=>{
